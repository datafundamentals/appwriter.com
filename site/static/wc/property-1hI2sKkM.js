...
function J(t, e) {
  if (!H(t) || !t.hasOwnProperty('raw')) throw Error('invalid template strings array');
...
const K = (t, e) => {
  ...
  for (let e = 0; e < s; e++) {
    ...
    let h,
      ...
      l = -1,
      c = 0;
    for (; c < s.length && ((o.lastIndex = c), (a = o.exec(s)), null !== a); )
      (c = o.lastIndex),
        o === M
          ? '!--' === a[1]
            ? (o = R)
          ...
          ? '>' === a[0]
            ...
            : void 0 === a[1]
            ? (l = -2)
            : ((l = o.lastIndex - a[2].length), (h = a[1]), (o = void 0 === a[3] ? z : '"' === a[3] ? j : L))
          : o === j || o === L
          ? (o = z)
          : o === R || o === k
          ? (o = M)
    ...
    n += o === M ? s + U : l >= 0 ? (i.push(h), s.slice(0, l) + w + s.slice(l) + P + d) : s + P + (-2 === l ? e : d);
  }
  return [J(t, n + (t[s] || '<?>') + (2 === e ? '</svg>' : 3 === e ? '</math>' : '')), i];
};
class Z {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    const o = t.length - 1,
      h = this.parts,
      [a, l] = K(t, e);
    if (((this.el = Z.createElement(a, s)), (q.currentNode = this.el.content), 2 === e || 3 === e)) {
          ...
          for (const t of i.getAttributeNames())
            if (t.endsWith(w)) {
              const e = l[n++],
                ...
                o = /([.?@])?(.*)/.exec(e);
              h.push({ type: 1, index: r, name: o[2], strings: s, ctor: '.' === o[1] ? Y : '?' === o[1] ? tt : '@' === o[1] ? et : X }),
                i.removeAttribute(t);
            } else t.startsWith(P) && (h.push({ type: 6, index: r }), i.removeAttribute(t));
        if (D.test(i.tagName)) {
          const t = i.textContent.split(P),
            e = t.length - 1;
          if (e > 0) {
            i.textContent = S ? S.emptyScript : '';
            for (let s = 0; s < e; s++) i.append(t[s], O()), q.nextNode(), h.push({ type: 2, index: ++r });
            i.append(t[e], O());
          }
        }
      } else if (8 === i.nodeType)
        if (i.data === C) h.push({ type: 2, index: r });
        else {
          let t = -1;
          for (; -1 !== (t = i.data.indexOf(P, t + 1)); ) h.push({ type: 7, index: r }), (t += P.length - 1);
        }
      r++;
    }
  }
...
function F(t, e, s = t, i) {
  ...
  return (
    r?.constructor !== n &&
      (r?._$AO?.(!1),
      void 0 === n ? (r = void 0) : ((r = new n(t)), r._$AT(t, s, i)),
      void 0 !== i ? ((s._$Co ??= [])[i] = r) : (s._$Cl = r)),
    void 0 !== r && (e = F(t, r._$AS(t, e.values), r, i)),
    e
  );
}
class G {
    ...
    for (; void 0 !== h; ) {
      if (n === h.index) {
        ...
        2 === h.type
          ...
          : 6 === h.type && (e = new st(r, this, t)),
          this._$AV.push(e),
          (h = s[++o]);
      }
      n !== h?.index && ((r = q.nextNode()), n++);
    }
...
class Q {
  ...
  _$AI(t, e = this) {
    (t = F(this, t, e)),
      T(t)
        ...
        : void 0 !== t.nodeType
        ? this.T(t)
        : (t => H(t) || 'function' == typeof t?.[Symbol.iterator])(t)
        ? this.k(t)
        : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== W && T(this._$AH) ? (this._$AA.nextSibling.data = t) : this.T(x.createTextNode(t)), (this._$AH = t);
  }
  $(t) {
    const { values: e, _$litType$: s } = t,
      i = 'number' == typeof s ? this._$AC(t) : (void 0 === s.el && (s.el = Z.createElement(J(s.h, s.h[0]), this.options)), s);
  ...
  k(t) {
    ...
    let s,
      i = 0;
    for (const r of t) i === e.length ? e.push((s = new Q(this.O(O()), this.O(O()), this, this.options))) : (s = e[i]), s._$AI(r), i++;
...
class X {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let n = !1;
    if (void 0 === r) (t = F(this, t, e, 0)), (n = !T(t) || (t !== this._$AH && t !== B)), n && (this._$AH = t);
    else {
      const i = t;
      let o, h;
...
class et extends X {
  ...
  _$AI(t, e = this) {
    if ((t = F(this, t, e, 0) ?? W) === B) return;
    const s = this._$AH,
      i = (t === W && s !== W) || t.capture !== s.capture || t.once !== s.once || t.passive !== s.passive,
      r = t !== W && (s === W || i);
...
const it = E.litHtmlPolyfillSupport;
it?.(Z, Q), (E.litHtmlVersions ??= []).push('3.2.1');
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      ...
      (this._$Do = ((t, e, s) => {
        ...
        if (void 0 === r) {
          ...
          i._$litPart$ = r = new Q(e.insertBefore(O(), t), t, void 0, s ?? {});
        }
        return r._$AI(t), r;
...
nt?.({ LitElement: rt }), (globalThis.litElementVersions ??= []).push('4.1.1');
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const ot = t => (e, s) => {
   ...
   * Copyright 2017 Google LLC
   * SPDX-License-Identifier: BSD-3-Clause
   */ ht = { attribute: !0, type: String, converter: m, reflect: !1, hasChanged: g },
  at = (t = ht, e, s) => {
    const { kind: i, metadata: r } = s;
    let n = globalThis.litPropertyMetadata.get(r);
    if ((void 0 === n && globalThis.litPropertyMetadata.set(r, (n = new Map())), n.set(s.name, t), 'accessor' === i)) {
      const { name: i } = s;
      return {
        set(s) {
...
export { n as i, lt as n, rt as r, ot as t, I as x };
