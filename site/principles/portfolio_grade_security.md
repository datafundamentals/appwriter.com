...
## Excellent, but not by dF

That portion of security which comes from the Firebase system, which is most of what is provided within the dF infrastructure, is excellent by almost any measure. Firebase is a well designed and well maintained system.

That portion of dF written by us - which was designed for "first day" highly decoupled app and site setup - this is the weak link in the chain. Since security is no better than the weakest link ... there's the source of the issue.
...
- If it doesn't stand alone, or causes one or more [dF Starter Apps](/dF/starter_apps/) to not be able to stand alone and be swappable with security.
- If it is needlessly or measureably more difficult to code against when in a PEG or Portfolio Electives Game

If your submittal is unacceptable for the above reasons, we would be happy to promote your contribution for others, we just can't in good conscience include it in our own dF.
